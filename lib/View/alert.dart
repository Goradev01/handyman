...
import 'package:handyman/View/Handymen/acceptbooking.dart';
import 'package:handyman/View/Handymen/location.dart';
import 'package:handyman/View/arrive.dart';
import 'package:handyman/View/booking.dart';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                          onTap: () {
                            nav(context, const Booking());
                          },
                          child:
                              button(commonText('Book Handyman', white), green))
                    ],
                  ),
                ),
              ),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          wspacer(3),
                          input(black, 16, 'Street name, Ajah', w500),
                        ],
                      ),
                      hspacer(32),
                      GestureDetector(
                          ...
                          child:
                              button(commonText('Begin Journey', white), green))
                    ],
                  ),
                ),
              ),
